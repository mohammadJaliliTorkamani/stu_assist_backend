...
function getPostsOfCategory($categoryID)
{
    ...
    $postsQuery = "SELECT BlogPost.id, BlogPost.title, overview, Photo.path as path, BlogPost.creation_date as CraetionDate, BlogPost.creation_time as CraetionTime 
    FROM BlogPost, Photo 
